...
🐍 **Python Backend Developer · 4+ years · 5+ production projects**
...
- 🔧 **Bash deployment pipeline** — 40 Django projects from `git clone` to SSL, fully automated
- 🤖 **Telegram job board bot** — 3 languages, geolocation search, moderation panel inside Telegram
...
- 🛠 Deepening: system design, Kafka, async Python
- 👀 Open to: **Full-time remote · Python Backend · Middle role**
